...
rfc_ble5AdvAuxPar_t ble5AdvAux_bt5le1m_0Par =
{
    .pRxQ = 0,
...
rfc_CMD_BLE5_ADV_AUX_t RF_cmdBle5AdvAux_bt5le1m_0 =
{
    .commandNo = 0x1824,
    .status = 0x0000,
    .pNextOp = 0,
    ...
    .rangeDelay = 0x00,
    .txPower = 0x0000,
    .pParams = &ble5AdvAux_bt5le1m_0Par,
    .pOutput = 0,
    .tx20Power = 0x00000000
};

// Structure for CMD_BLE5_GENERIC_RX.pParam
rfc_bleGenericRxPar_t bleGenericRx_bt5le1m_0Par =
{
    .pRxQ = 0,
    .rxConfig.bAutoFlushIgnored = 0x0,
    .rxConfig.bAutoFlushCrcErr = 0x0,
...
rfc_CMD_BLE5_GENERIC_RX_t RF_cmdBle5GenericRx_bt5le1m_0 =
{
    .commandNo = 0x1829,
    .status = 0x0000,
    .pNextOp = 0,
    ...
    .rangeDelay = 0x00,
    .txPower = 0x0000,
    .pParams = &bleGenericRx_bt5le1m_0Par,
    .pOutput = 0,
    .tx20Power = 0x00000000
};
...
rfc_CMD_RADIO_SETUP_t RF_cmdRadioSetup_ieee154_1 =
{
    .commandNo = 0x0802,
    .status = 0x0000,
    .pNextOp = 0,
    ...
    .config.bSynthNarrowBand = 0x0,
    .txPower = 0x7217,
    .pRegOverride = pOverrides_ieee154_1
};

// CMD_FS
// Frequency Synthesizer Programming Command
rfc_CMD_FS_t RF_cmdFs_ieee154_1 =
{
    .commandNo = 0x0803,
    .status = 0x0000,
    .pNextOp = 0,
...
rfc_CMD_IEEE_RX_t RF_cmdIeeeRx_ieee154_1 =
{
    .commandNo = 0x2801,
    .status = 0x0000,
    .pNextOp = 0,
